...
- `link_color` (optional): possible values: `black`, `white`. Defaults to standard link color.
...
This shortcode:
```{shortcodes=false}
{{< icon-link title="Land" icon_library="lsc" icon="land" link="https://www.lsc-hubs.org" link_color="black" >}}
```
